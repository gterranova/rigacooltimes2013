(function() {
  ...
  function crudRouteProvider($routeProvider) {
    ...
    this.routesFor = function(resourceName, urlPrefix, routePrefix, controllerPrefix) {
      var baseUrl = resourceName.toLowerCase();
      var baseRoute = '/' + resourceName.toLowerCase();
      routePrefix = routePrefix != undefined ? routePrefix : urlPrefix;
      ...
      var controllerName = function(operation) {
          if (controllerPrefix !== null && controllerPrefix !== undefined && controllerPrefix !== '') {
            return controllerPrefix + resourceName + operation +'Ctrl';
          }          
