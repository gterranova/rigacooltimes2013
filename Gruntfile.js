...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
      ...
      dist: {
        files: {
          src: [
            ...
            '!<%= yeoman.dist %>/scripts/{,**/}gravatar.js',
            '<%= yeoman.dist %>/styles/{,*/}*.css',
            '<%= yeoman.dist %>/images/{,**/}*.{png,jpg,jpeg,gif,webp,svg}',
            '!<%= yeoman.dist %>/images/slideshow/*.{png,jpg,jpeg,gif,webp,svg}',
    ...
    usemin: {
      html: ['<%= yeoman.dist %>/{,*/}*.html', '!<%= yeoman.dist %>/scripts/**/*.tpl.html'],
